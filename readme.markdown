#ianpatrickhines.com (Version 2.0)
...
License: The MIT License (MIT) (See [LICENSE.markdown](https://github.com/ianpatrickhines/ianpatrickhines-flat-blue/blob/master/LICENSE.markdown))
